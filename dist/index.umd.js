...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('util'), require('fs'), require('url'), require('http'), require('https'), require('jsonpath-plus')) :
  typeof define === 'function' && define.amd ? define(['util', 'fs', 'url', 'http', 'https', 'jsonpath-plus'], factory) :
  (global = global || self, global.JSONSchemaFaker = factory(global.util$1, global.fs, global.url, global.http, global.https, global.jsonpathPlus));
}(this, function (util$1, fs, url, http, https, jsonpathPlus) { 'use strict';
  ...
  const inspectMethod = util$1.inspect.custom || Symbol.for("nodejs.util.inspect.custom");
  /**
   * Ono supports Node's `util.format()` formatting for error messages.
   *
   * @see https://nodejs.org/api/util.html#util_util_format_format_args
   */
  const formatter = util$1.format;
  /**
  ...
  const protectedProps$1 = ["name", "message", "stack"];
  /**
  ...
  function mergeErrors(newError, originalError) {
      ...
      let keys = getDeepKeys(originalError, protectedProps$1);
  ...
  var yaml_1 = {
    ...
    stringify (value, replacer, space) {
      try {
        ...
        return jsYaml$1.safeDump(value, { indent });
      }
      catch (e) {
        if (e instanceof Error) {
          throw e;
  ...
  exports.isHttp = function isHttp (path) {
    let protocol = url$1.getProtocol(path);
  ...
  function inventory$Ref ($refParent, $refKey, path, pathFromRoot, indirections, inventory, $refs, options) {
    ...
    let pointer$1 = $refs._resolve($refPath, options);
  ...
  function dereference (parser, options) {
    ...
    let dereferenced = crawl$2(parser.schema, parser.$refs._root$Ref.path, "#", [], parser.$refs, options);
  ...
  function dereference$Ref ($ref, path, pathFromRoot, parents, $refs, options) {
    ...
    if (!circular) {
      ...
      let dereferenced = crawl$2(dereferencedValue, pointer.path, pathFromRoot, parents, $refs, options);
      circular = dereferenced.circular;
  ...
  $RefParser.prototype.parse = async function (path, schema, options, callback) {
    ...
    if (!args.path && !args.schema) {
      let err = ono$7(`Expected a file path, URL, or object. Got ${args.path || args.schema}`);
